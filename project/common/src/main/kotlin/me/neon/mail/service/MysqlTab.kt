 ...
 * @since 2024/1/3 9:56
 */
enum class MysqlTab(val tab: String) {
    ...
    MAIL_TAB_INDEX_1(
        "CREATE INDEX IF NOT EXISTS idx_sender_target ON ${SQLImpl.mailTAB}(sender, target);"
    ),
    // 用户
    USER_TAB(
    ...
    DRAFT_TAB_INDEX_1(
        "CREATE INDEX IF NOT EXISTS idx_sender ON $draftTAB(sender);"
    ),
}