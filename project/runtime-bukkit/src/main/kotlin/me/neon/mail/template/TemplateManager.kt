...
import me.neon.mail.api.io.forFile
import me.neon.mail.api.io.saveToFile
import me.neon.mail.api.io.yaml
...
object TemplateManager {
    ...
    private val templateTypeRegister: MutableMap<Any, TemplateType<*>> = mutableMapOf()
    ...
    @JvmStatic
    fun registerType(key: String, type: TemplateType<*>) {
    ...
    internal fun loaderTemplate() {
        ...
        measureTimeMillis {
            saveDefaultTemp.forFile("yml").forEach {
                ...
                val pack = mutableListOf<TemplateType<*>>()
