...
object NeonMailLoader {
    ...
    internal const val clusterId: String = "NeonMail"
    ...
    private fun register() {
        IMailDefaultImpl(IMailRegister.console, IMailRegister.console, IMailRegister.console)
            .register()
