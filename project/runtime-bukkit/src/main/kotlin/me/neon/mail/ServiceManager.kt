...
import me.neon.mail.api.io.asyncRunnerResult
import me.neon.mail.api.io.asyncRunnerWithResult
...
object ServiceManager {
    ...
    private val smtp: SmtpService by lazy {
        SmtpService(bukkitPlugin, NeonMailLoader.smtpTranslate)
    }
    ...
    fun getOffPlayerData(uuid: UUID): CompletableFuture<PlayerData> {
